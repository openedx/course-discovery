...
from au_amber.apps.core import views as core_views
from au_amber.apps.courses.views import QueryPreviewView
...
urlpatterns = [
    ...
    url(r'^api/', include('au_amber.apps.api.urls', namespace='api')),
