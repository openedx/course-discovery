...
from course_catalog.apps.core.tests.factories import UserFactory, USER_PASSWORD
from course_catalog.apps.course_metadata.models import Course
from course_catalog.apps.course_metadata.tests.factories import CourseFactory
