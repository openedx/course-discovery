...
from course_catalog.apps.api.serializers import AffiliateWindowSerializer
from course_catalog.apps.api.v1.tests.test_views.mixins import SerializationMixin
...
from course_catalog.apps.course_metadata.models import Seat
from course_catalog.apps.course_metadata.tests.factories import CourseRunFactory, SeatFactory
