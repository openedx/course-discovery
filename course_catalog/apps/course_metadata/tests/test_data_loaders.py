...
from course_catalog.apps.course_metadata.data_loaders import (
...
from course_catalog.apps.course_metadata.tests.factories import (
...
class CoursesApiDataLoaderTests(DataLoaderTestMixin, TestCase):
    ...
    def test_ingest_exception_handling(self):
        ...
        with mock.patch.object(self.loader, 'clean_strings', side_effect=Exception):
            with mock.patch('course_catalog.apps.course_metadata.data_loaders.logger') as mock_logger:
                self.loader.ingest()
