...
from course_catalog.apps.core import views as core_views
from course_catalog.apps.course_metadata.views import QueryPreviewView
...
urlpatterns = [
    ...
    url(r'^api/', include('course_catalog.apps.api.urls', namespace='api')),
