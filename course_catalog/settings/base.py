...
SECRET_KEY = os.environ.get('COURSE_catalog_SECRET_KEY', 'insecure-secret-key')
...
PROJECT_APPS = (
    'course_catalog.apps.core',
    'course_catalog.apps.ietf_language_tags',
    'course_catalog.apps.api',
    'course_catalog.apps.catalogs',
    'course_catalog.apps.course_metadata',
)
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': (
                ...
                'course_catalog.apps.core.context_processors.core',
            ),
...
SESSION_COOKIE_NAME = 'course_catalog_sessionid'
CSRF_COOKIE_NAME = 'course_catalog_csrftoken'
LANGUAGE_COOKIE_NAME = 'course_catalog_language'
...
syslog_format = '[service_variant=catalog][%(name)s] %(levelname)s [{hostname}  %(process)d] ' \
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_CLASSES': (
        'course_catalog.apps.core.throttles.OverridableUserRateThrottle',
    ),
...
JWT_AUTH = {
    'JWT_ALGORITHM': 'HS256',
    'JWT_AUDIENCE': 'course-catalog',
    'JWT_ISSUER': 'course-catalog',
...
SWAGGER_SETTINGS = {
    ...
    'permission_denied_handler': 'course_catalog.apps.api.views.api_docs_permission_denied_handler'
}

HAYSTACK_CONNECTIONS = {
    'default': {
        'ENGINE': 'course_catalog.apps.core.haystack_backends.SimplifiedElasticsearchSearchEngine',
