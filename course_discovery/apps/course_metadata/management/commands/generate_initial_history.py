...
class Command(BaseCommand):
    ...
    Example usage:
    $ ./manage.py generate_initial_history --batchsize 1000 --sleep_between 1 --settings=devstack
    """
    ...
    TABLE_MAPPING = {
        'course_metadata_course': 'course_metadata_historicalcourse',
        'course_metadata_courserun': 'course_metadata_historicalcourserun',
        'course_metadata_program': 'course_metadata_historicalprogram',
        'course_metadata_programtype': 'course_metadata_historicalprogramtype',
        'course_metadata_courseentitlement': 'course_metadata_historicalcourseentitlement',
        'course_metadata_seat': 'course_metadata_historicalseat',
        'core_partner': 'core_historicalpartner',
    }
