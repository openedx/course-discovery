...
class ProgramAdmin(admin.ModelAdmin):
    ...
    fields = (
        ...
        'marketing_slug', 'overview', 'credit_redemption_overview', 'video', 'weeks_to_complete', 'start_date',
        'end_date', 'continuing_education_units', 'min_hours_effort_per_week', 'max_hours_effort_per_week', 'courses', 'order_courses_by_start_date',
