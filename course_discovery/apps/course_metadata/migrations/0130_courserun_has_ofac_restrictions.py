# Generated by Django 1.11.15 on 2018-11-20 15:18
...
def migrate_has_ofac_restriction_data(apps, schema_editor):
    course_model = apps.get_model('course_metadata', 'Course')
    course_run_model = apps.get_model('course_metadata', 'CourseRun')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('course_metadata', '0129_auto_20181113_1415'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False,
                verbose_name='Add OFAC restriction text to the FAQ section of the Marketing site'
            ),
        ),
