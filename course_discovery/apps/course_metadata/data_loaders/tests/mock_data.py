...
MULTI_COURSE_RUN_COURSE_NUMBER = 'CB22x'
...
MARKETING_SITE_API_COURSE_BODIES = [
    ...
    {
        'field_course_code': MULTI_COURSE_RUN_COURSE_NUMBER,
        'field_course_course_title': {
...
MARKETING_SITE_API_UNPUBLISHED_COPY_COURSE_BODY = {
    'field_course_code': MULTI_COURSE_RUN_COURSE_NUMBER,
    'field_course_course_title': {
        'value': 'The Ancient Greek Hero UNPUBLISHED',
        'format': 'basic_html'
    },
    'field_course_description': {
        'value': 'UNPUBLISHED <p><b>NOTE ABOUT OUR START DATE:</b> Although the course was launched on March 13th, '
                 'it\u0027s not too late to start participating! New participants will be joining the course until '
                 '<strong>registration closes on July 11</strong>. We offer everyone a flexible schedule and '
                 'multiple paths for participation. You can work through the course videos and readings at your '
                 'own pace to complete the associated exercises <strong>by August 26</strong>, the official course '
    ...
    'field_course_image_promoted': {
        ...
        'mime': 'image/jpeg',
        'size': '34861',
        'url': 'https://www.edx.org/sites/default/files/course/image/promoted/tombstone_courses_UNPUBLISHED.jpg',
        'timestamp': '1384348699',
        'owner': {
            'uri': 'https://www.edx.org/user/1',
            'id': '1',
    ...
    'field_course_is_disabled': None,
    'field_course_tags': [],
    'field_course_sub_title_short': 'UNPUBLISHED A survey of ancient Greek literature focusing on classical concepts of'
...
MARKETING_SITE_API_PUBLISHED_COPY_COURSE_BODY = {
    'field_course_code': MULTI_COURSE_RUN_COURSE_NUMBER,
    'field_course_course_title': {
        'value': 'The Ancient Greek Hero PUBLISHED',
        'format': 'basic_html'
    },
    'field_course_description': {
        'value': 'PUBLISHED <p><b>NOTE ABOUT OUR START DATE:</b> Although the course was launched on March 13th, '
                 'it\u0027s not too late to start participating! New participants will be joining the course until '
                 '<strong>registration closes on July 11</strong>. We offer everyone a flexible schedule and '
                 'multiple paths for participation. You can work through the course videos and readings at your '
                 'own pace to complete the associated exercises <strong>by August 26</strong>, the official course '
    ...
    'field_course_image_promoted': {
        ...
        'mime': 'image/jpeg',
        'size': '34861',
        'url': 'https://www.edx.org/sites/default/files/course/image/promoted/tombstone_courses_PUBLISHED.jpg',
        'timestamp': '1384348699',
        'owner': {
            'uri': 'https://www.edx.org/user/1',
            'id': '1',
    ...
    'field_course_id': 'HarvardX/CB22x/2015_Spring',
    'field_course_image_sample_cert': [],
    'field_course_image_sample_thumb': [],
    'field_course_enrollment_audit': True,
    'field_course_enrollment_honor': False,
    ...
    'field_course_is_disabled': None,
    'field_course_tags': [],
    'field_course_sub_title_short': 'PUBLISHED A survey of ancient Greek literature focusing on classical concepts of'
                                    ' the hero and how they can inform our understanding of the human condition.',
    'field_course_length_weeks': '23 weeks',
    'field_course_start_date_style': None,
    'field_course_head_prom_bkg_color': None,
    ...
    'revision': None,
    'body': [],
    'uuid': '6b8b779f-f567-4e98-aa41-a265d6fa073e',
    'vuuid': 'e0f8c80a-b377-4546-b247-1c94ab3a218e'
}
