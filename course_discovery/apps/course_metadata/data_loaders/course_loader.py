...
class CourseLoader(AbstractDataLoader, DataLoaderMixin):
    ...
    def update_course_api_request_data(self, course_data, course, is_draft):
        ...
        update_course_data = {
            ...
            'type': str(self.get_course_run_type(course_data.get('course_enrollment_track')).uuid or course.type.uuid),
            'subjects': subjects,
    ...
    def update_course_run_api_request_data(self, course_run_data, course_run, course_type, is_draft):
        ...
        update_course_run_data = {
            'run_type': str(self.get_course_run_type(
                course_run_data.get('course_run_enrollment_track')).uuid or course_run.type.uuid),
            'key': course_run.key,
