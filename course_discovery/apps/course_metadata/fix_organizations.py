...
from course_discovery.apps.course_metadata.models import Course, Organization, Position, Program
...
organizations = list(
    Organization.objects.filter(partner_id__in=[1, 4])
    .exclude(key='HarvardMedGlobalAcademy')
