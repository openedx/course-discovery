...
class UnpublishedCourseRunListing(TestCase):
    ...
    def _assert_un_published_data(self, response):
        ...
        # TODO need to fix the date format in templates
        # self.assertContains(response, self.course_run.status.created)
        # self.assertContains(response, self.course_run.status.modified)
