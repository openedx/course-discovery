...
class Partner(TimeStampedModel):
    ...
    analytics_url = models.URLField(max_length=255, null=True, blank=True, verbose_name=_('Analytics API URL'))
    analytics_token = models.CharField(max_length=255, null=True, blank=True, verbose_name=_('Analytics Access Token'))
