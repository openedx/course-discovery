...
try:
    logger.info('GOOGLE_SERVICE_ACCOUNT_CREDENTIALS: {}'.format(GOOGLE_SERVICE_ACCOUNT_CREDENTIALS))
    GOOGLE_SERVICE_ACCOUNT_CREDENTIALS = json.loads(GOOGLE_SERVICE_ACCOUNT_CREDENTIALS)
except json.decoder.JSONDecodeError:
    logger.warning('GOOGLE_SERVICE_ACCOUNT_CREDENTIALS: {}'.format(GOOGLE_SERVICE_ACCOUNT_CREDENTIALS))
